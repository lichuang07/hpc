<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 中国海洋大学. <a href="/">高性能俱乐部</a>.</strong>
  </footer>
...
<!-- 自定义ｊｓ -->
<script type="text/javascript" src="/admin/js/commom.js"></script>
<script src="{{isset($method)?"/admin/js/{$action}/{$method}.js":''}}"></script>
<script>
  $(function () {
    $('#example1').DataTable()
    $('#example2').DataTable({
