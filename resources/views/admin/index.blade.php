    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">出勤</span>
            <span class="info-box-number">100<small>%</small>
              <br>
              0<small>/0</small>
            </span>
          </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">未读邮件</span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">所属小组</span>
            <span class="info-box-number">暂无</span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-8">
            ...
            <div class="row">
              <div class="col-md-9 col-sm-8">
                <div class="pad">
                  ...
                  <button type="button" class="btn btn-info btn-block" title="发布者:{{$pub->nickname}}"
                    data-container="body" data-toggle="popover" data-placement="right"
                    data-content="{{$pub->body}}">
                      {{$pub->title}} <small class="pull-right">{{$pub->nickname}}</small>
                  </button>
                  @endforeach
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-4">
                <div class="pad box-pane-right bg-green" style="min-height: 280px">
                  <div class="description-block margin-bottom">
                    ...
                    <h5 class="description-header">{{$publics->count()}}</h5>
                    <span class="description-text">num</span>
                  </div>
                  <!-- /.description-block -->
                  <!-- <div class="description-block margin-bottom">
            ...
            <div class="box box-warning direct-chat direct-chat-warning">
              ...
              <div class="box-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    <div class="direct-chat-info clearfix">
                      <span class="direct-chat-name pull-left">李闯</span>
        ...
        <div class="box box-info">
              ...
              <table class="table no-margin">
                ...
                <tbody>
                  <tr>
                    <td><a href="">迎新</a></td>
                    <td>百团大战</td>
                    <td><span class="label label-success">准备中</span></td>
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20">08-30</div>
                    </td>
                  </tr>
                  <tr>
                    <td><a href="">网站制作</a></td>
                    ...
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20">08-20/结束时间未知</div>
                    </td>
                  </tr>
                <!-- <tr>
          ...
          <div class="box-footer clearfix">
            @if(hpcAuth()->isAdmin())
            <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">添加事项</a>
            @endif
